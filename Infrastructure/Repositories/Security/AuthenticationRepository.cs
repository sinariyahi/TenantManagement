...
namespace Infrastructure.Repositories.Security
{
    public class AuthenticationRepository : IAuthenticationRepository
    {
        ...
        public AuthenticationRepository(IConnectionUtility connectionUtility)
          //  IRedisService<User> redisService)
        {
        ...
        public async Task<List<object>> GetUser(string userName)
        {
            ...
            using (var dapper = connectionUtility.NewConnection())
            {
                ...
                var results = await dapper.QueryMultipleAsync("Pharmacy_Security_User_Login", new { userName = userName }, commandType: System.Data.CommandType.StoredProcedure);
